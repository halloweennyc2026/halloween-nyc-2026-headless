  ...
  },
  {
    ...
    clauses: [
      ...
      },
      {
        ...
        body: "This website uses the Meta Pixel, an advertising and analytics tool from Meta Platforms, Inc., to measure visits and ticket-link clicks and to show relevant ads on Facebook and Instagram. It may set cookies and collect information such as pages viewed, browser and device details, and IP address, which Meta processes under its own privacy policy. It also uses Google Analytics, a web analytics service from Google LLC, to understand how visitors use the site, such as pages viewed and ticket-link clicks. Google Analytics sets cookies and processes information such as pages viewed, device and browser details, and approximate location under Google's own privacy policy. You can opt out with the Google Analytics Opt-out Browser Add-on (tools.google.com/dlpage/gaoptout). Links to ticket platforms may carry ad-campaign identifiers so purchases can be attributed to the ad that led to them. You can manage ad preferences in your Facebook or Instagram settings, block cookies in your browser, or opt out of interest-based ads at optout.aboutads.info.",
      },
      {
